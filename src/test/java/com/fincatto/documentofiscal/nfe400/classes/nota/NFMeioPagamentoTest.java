...
public class NFMeioPagamentoTest {
    ...
    public void deveRepresentarCodigoDescricaoConcatenado() {
        ...
        Assert.assertEquals("05 - Cartão da loja", NFMeioPagamento.CARTAO_LOJA.toString());
        ...
        Assert.assertEquals("15 - Boleto bancario", NFMeioPagamento.BOLETO_BANCARIO.toString());
        Assert.assertEquals("16 - Deposito bancario", NFMeioPagamento.DEPOSITO_BANCARIO.toString());
        Assert.assertEquals("17 - Pagamento Instantâneo (PIX) - Dinâmico", NFMeioPagamento.PIX_DINAMICO.toString());
        Assert.assertEquals("18 - Transferencia bancaria", NFMeioPagamento.TRANSFERENCIA_BANCARIA.toString());
